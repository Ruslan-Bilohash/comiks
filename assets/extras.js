...
(() => {
  ...
  const JX = {
    uk: {
      ...
      lead: ['🎮 ГРА ТИЖНЯ', 'Гра разом: увесь клас на одному екрані', 'Вчитель відкриває кімнату й показує QR-код — учні сканують його телефонами, вводять ім’я й одразу грають. Питання норвезькою на час, бали за швидкість, таблиця лідерів після кожного раунду. Жодних імен персонажів: відповідь завжди видно з картинки чи звуку. На телефоні гра займає весь екран.', '#/game', '🎲 Випадкова кімната'],
      cards: [
        ['🏁 НОВА ГРА', 'Логік-гонка', 'Живі аватари мчать доріжками: хто швидше розв’язує логічні задачі, той обганяє. Траса на моніторі, відповіді — на телефонах. Можна й проти ботів!', '#/race'],
    ...
    en: {
      ...
      lead: ['🎮 GAME OF THE WEEK', 'Play together: the whole class on one screen', 'The teacher opens a room and shows the QR code — students scan it with their phones, type a name and play straight away. Timed questions in Norwegian, points for speed and a leaderboard after every round. No character names: the answer is always visible in the picture or the sound. On a phone the game fills the whole screen.', '#/game', '🎲 Random room'],
      cards: [
        ['🏁 NEW GAME', 'Logic Race', 'Live avatars race along the track: solve logic puzzles faster to overtake. The track on the monitor, answers on phones. You can also race bots!', '#/race'],
    ...
    no: {
      ...
      lead: ['🎮 UKENS SPILL', 'Spill sammen: hele klassen på én skjerm', 'Læreren lager et rom og viser QR-koden – elevene skanner den med mobilen, skriver navnet og spiller med en gang. Spørsmål på norsk på tid, poeng for fart og resultatliste etter hver runde. Ingen navn på figurer: svaret ser du alltid på bildet eller hører i lyden.', '#/game', '🎲 Tilfeldig rom'],
      cards: [
        ['🏁 NYTT SPILL', 'Logikkløpet', 'Levende avatarer løper om kapp: løs logiske oppgaver raskere og forbikjør de andre. Banen på skjermen, svarene på mobilen.', '#/race'],
